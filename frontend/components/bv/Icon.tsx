...
const BV_ICON_PATHS: Record<string, string> = {
  ...
  tiktok: '<path d="M9 12.5A3.5 3.5 0 1 0 12.5 16V3.5a5.5 5.5 0 0 0 5.5 5.5"/>',
  ...
  shuffle:
    '<path d="M2 18h1.4c1.3 0 2.5-.6 3.3-1.7l6.1-8.6c.7-1.1 2-1.7 3.3-1.7H22"/><path d="m18 2 4 4-4 4"/><path d="M2 6h1.9c1.5 0 2.9.9 3.6 2.2"/><path d="m18 14 4 4-4 4"/><path d="M10.3 17.4c.7 1.1 2 1.6 3.3 1.6H22"/>',
